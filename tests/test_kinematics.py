...
@pytest.mark.parametrize(("angle", "expected"),[(0.0, 0.0),(math.tau, 0.0),(-math.tau, 0.0),(3.0 * math.pi / 2.0, -math.pi / 2.0)])
...
def test_reject_invalid_robot_geometry(wheel_radius: float,wheel_separation: float,) -> None:
